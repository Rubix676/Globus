...
const translations = {
  uz: {
    ...
    "courses.subtitle": "Ingliz tili, MATEMATIKA, nemis va koreys tili.",
    "courses.english": "Ingliz tili IELTS/CEFR",
    "courses.englishText": "General English va speaking.",
    "courses.ielts": "MATEMATIKA",
    "courses.ieltsText": "SAT va mental arifmetika.",
    ...
    "schedule.eyebrow": "Ilova",
    "schedule.title": "Globus Edu Student — markaz ilovasi",
    "schedule.text": "Globus Edu Student — o‘quvchilar va ota-onalar uchun mobil ilovamiz. Dars jadvali, davomat, baholar va markaz yangiliklari — barchasi telefoningizda, bitta joyda.",
    "schedule.studentsTitle": "O‘quvchilar uchun",
    "schedule.students1": "Shaxsiy jadval va darslar haqida eslatmalar",
    "schedule.students2": "Uy vazifalari va dars materiallari bir joyda",
    "schedule.students3": "Har bir yo‘nalish bo‘yicha baholar va natijalar",
    "schedule.parentsTitle": "Ota-onalar uchun",
    "schedule.parents1": "Farzandingiz davomati va o‘zlashtirishi real vaqtda",
    "schedule.parents2": "To‘lov va markaz yangiliklari bo‘yicha bildirishnomalar",
    "schedule.parents3": "O‘qituvchilar va ma’muriyat bilan to‘g‘ridan-to‘g‘ri aloqa",
    "schedule.appText": "Ilovani yuklab oling va o‘quv jarayonidagi har bir yangilikdan xabardor bo‘ling.",
    "schedule.storeBadge": "Yuklab olish",
  ...
  ru: {
    ...
    "schedule.eyebrow": "Приложение",
    "schedule.title": "Globus Edu Student — приложение центра",
    "schedule.text": "Globus Edu Student — наше мобильное приложение для учеников и родителей. Расписание, посещаемость, оценки и новости центра — всё в одном месте, на телефоне.",
    "schedule.studentsTitle": "Для учеников",
    "schedule.students1": "Личное расписание и напоминания о занятиях",
    "schedule.students2": "Домашние задания и материалы уроков в одном месте",
    "schedule.students3": "Оценки и прогресс по каждому направлению",
    "schedule.parentsTitle": "Для родителей",
    "schedule.parents1": "Посещаемость и успеваемость ребёнка в реальном времени",
    "schedule.parents2": "Уведомления об оплате и новостях центра",
    "schedule.parents3": "Прямая связь с преподавателями и администрацией",
    "schedule.appText": "Скачайте приложение и будьте в курсе всего, что происходит в учёбе.",
    "schedule.storeBadge": "Скачать в",
  ...
  en: {
    ...
    "schedule.eyebrow": "App",
    "schedule.title": "Globus Edu Student — the centre app",
    "schedule.text": "Globus Edu Student is our mobile app for students and parents. Schedule, attendance, grades and centre news — all in one place, on your phone.",
    "schedule.studentsTitle": "For students",
    "schedule.students1": "Personal schedule and lesson reminders",
    "schedule.students2": "Homework and lesson materials in one place",
    "schedule.students3": "Grades and progress for every direction",
    "schedule.parentsTitle": "For parents",
    "schedule.parents1": "Your child's attendance and performance in real time",
    "schedule.parents2": "Payment reminders and centre announcements",
    "schedule.parents3": "Direct contact with teachers and the administration",
    "schedule.appText": "Download the app and stay on top of everything in the learning process.",
    "schedule.storeBadge": "Get it on",
